...
<div class="min-h-[75%] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      <div>
        ...
        <h2 class="mt-8 text-center text-3xl font-semibold text-gray-700 dark:text-gray-400">Create an account</h2>
      ...
      <form class="mt-5 space-y-6" on:submit|preventDefault={handleLogin}>
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          <div>
            ...
            <input id="username" bind:value={username} name="username" type="username" autocomplete="username" required class="input-field rounded-t-md" placeholder="Username">
          </div>
          <div>
